...
scp data/week${week}.jpg fk@otax.fi:~/www/wp-content/uploads/viikkotiedote-data &&
scp data/week${week}-en.jpg fk@otax.fi:~/www/wp-content/uploads/viikkotiedote-data
